...
func newEvewntResponseBuilder() *eventResponseBuilder {
	return &eventResponseBuilder{
		unmarshaler: &jsonUnmarshaler{},
	}
}

func (b *eventResponseBuilder) build(data []byte, v any) error {
	return b.unmarshaler.unmarshal(data, v)
}
